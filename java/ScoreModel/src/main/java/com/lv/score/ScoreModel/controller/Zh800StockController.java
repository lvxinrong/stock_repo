 ...
 */
@RestController
@RequestMapping("/zh800Stock")
public class Zh800StockController {
    ...
    public PageInfo<CalculateResultMonthEsEntity> getMonthScore(@RequestParam(value = "page", defaultValue = "1") int page,
        ...
        String indexName = ZH800_INDEX_NAME + (StringUtils.isBlank(stockMonth) ? stockMonthDefault : stockMonth);
