...
def query_index_daily(index_code):
    year = 2024
    month = 10
...
query_index_daily("000905.SH")
query_index_daily("000906.SH")
query_index_daily("000852.SH")
query_index_daily("399300.SZ")
query_index_daily("000903.SH")
