...
def get_limit_up_basic_info(trade_date):
    pro = get_tushare_api_pro()
    data = pro.limit_list_ths(trade_date=trade_date)
    # 转换为DataFrame
...
def get_limit_up_basic_info_by_month(startYear, startMonth, endYear, endMonth):
...
def update_curr_date():
    get_limit_up_basic_info(datetime.today().strftime('%Y%m%d'))


if __name__ == '__main__':
    # get_limit_up_basic_info_by_month(2025, 1, 2025, 3)
    update_curr_date()
